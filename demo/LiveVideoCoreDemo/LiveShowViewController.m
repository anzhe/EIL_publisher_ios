...
-(void) OnCameraChangeClicked:(id)sender{
    ...
    [[LiveVideoCoreSDK sharedinstance] EILSetCameraFront:_bCameraFrontFlag];
...
-(void) OnFilterClicked:(id)sender{
    ...
    [_FilterMenu setSelectedBlock:^(NSUInteger tag, NSString *title) {
        ...
        switch(tag) {
            case 0://原图像
                NSLog(@"设置无滤镜...");
                [[LiveVideoCoreSDK sharedinstance] EILSetFilter:LIVE_FILTER_ORIGINAL];
                break;
            case 1://美颜
                NSLog(@"设置美艳滤镜...");
                [[LiveVideoCoreSDK sharedinstance] EILSetFilter:LIVE_FILTER_BEAUTY];
                break;
            case 2://复古
                NSLog(@"设置复古滤镜...");
                [[LiveVideoCoreSDK sharedinstance] EILSetFilter:LIVE_FILTER_ANTIQUE];
                break;
            case 3://黑白
                NSLog(@"设置黑白滤镜...");
                [[LiveVideoCoreSDK sharedinstance] EILSetFilter:LIVE_FILTER_BLACK];
                break;
            default:
                break;
        }
...
-(void) OnExitClicked:(id)sender{
    ...
    [[LiveVideoCoreSDK sharedinstance] EILDisconnect];
    [[LiveVideoCoreSDK sharedinstance] EILLiveRelease];
